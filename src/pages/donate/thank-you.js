...
class Page extends React.Component {
    ...
    render() {
        return (
            <div>
                <Helmet>
                    <title>{`Thank You For Blerp Donation | You Are a Huge Help | Blerp`}</title>
                    <meta
                        name='description'
                        content={`You are the best! Thanks for helping blerp grow! We are a free platform for you to discover, share, and create short audio clips.`}
                    />
                    <meta
                    ...
                    <meta
                        name='keywords'
                        content={`Thank you so much, thank you blerps, thanks for helping us donation to blerp, helping start ups, blerp funds, how does blerp make money?`}
                    />
                    <meta
                        property='og:image'
                ...
                <Container>
                    <OverlayBackground>
                        <Column>
                            ...
                            <Paragraph>We received your donation!</Paragraph>
