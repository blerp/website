...
class TwitchPromotionWalkon extends React.Component {
    props;
    navigateToSecond = () => {
        this.props.logAction({
            action: "WALKON_BANNER_TO_DISCORD_INVITE",
    ...
    navigateToTwitchStream = () => {
        this.props.logAction({
            action: "WALKON_BANNER_TO_STREAMS",
            event: "WEBSITE_NAVIGATION_EVENT",
            data: {},
        });
    ...
    navigateToApps = () => {
        this.props.logAction({
            action: "WALKON_BANNER_TO_MOBILE_APPS",
            event: "WEBSITE_NAVIGATION_EVENT",
            data: {},
        });
...
export default withRouter(withLogging(TwitchPromotionWalkon));
